...
All notable changes to `z4j-arq` are documented in this file.
...
- **`z4j-arq` console script** + `python -m z4j_arq` module
  form. Both work and dispatch to the same code path. Subcommands:
  - `doctor` - check upstream `arq` library + adapter import + broker URL
  - `check` - alias for doctor
  - `status` - one-line: package presence + broker URL state
  - `version` - print z4j-arq version
  ...
  into these same probes automatically when arq is the detected
  engine.
...
- Repository: <https://github.com/z4jdev/z4j-arq>
- Issues: <https://github.com/z4jdev/z4j-arq/issues>
- PyPI: <https://pypi.org/project/z4j-arq/>

[Unreleased]: https://github.com/z4jdev/z4j-arq/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/z4jdev/z4j-arq/releases/tag/v1.0.0
